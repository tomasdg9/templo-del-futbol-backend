...
<form  method="POST" action="{{route('categorias.store')}}">
    ...
    @endif
        ...
        <input type="text" class="form-control mb-2" name="nombre" id="exampleFormControlInput1" placeholder="Ejemplo: Remeras deportivas">

        <label for="exampleFormControlInput1" class="form-label">Descripcion</label>
        <textarea rows="5" class="form-control mb-2" name="descripcion" id="exampleFormControlInput1" placeholder="Ejemplo: Remera ideales para el entrenamiento de cualquier deporte. Tela Dri-Fit inspirada en Nike"        ></textarea>
